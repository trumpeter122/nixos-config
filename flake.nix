{
  ...
  inputs = {
    ...
    home-manager.url = "https://mirrors.tuna.tsinghua.edu.cn/nix-community/home-manager/archive/release-25.11.tar.gz";
  ...
  outputs =
    ...
    in
    {
      ...
      # Available through 'nixos-rebuild --flake .#__HOSTNAME__'
      nixosConfigurations = {
